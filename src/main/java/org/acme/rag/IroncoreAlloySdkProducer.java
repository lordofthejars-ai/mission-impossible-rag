...
public class IroncoreAlloySdkProducer {
    ...
    private StandaloneConfiguration getStandaloneConfiguration(StandardSecrets standardSecrets, Map<SecretPath, RotatableSecret> deterministicSecrets) throws AlloyException {
